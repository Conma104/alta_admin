...
<html lang="en">
  ...
  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('images/alta_htqlixephang.jpg');"></div>
    <div class="contents order-2 order-md-1">

      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3>ALTA <strong>Media@</strong></h3>
            

      <form action="/template/admin/index3.html" method="post"> 
